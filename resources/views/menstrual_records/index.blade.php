                    ...
                    <tbody class="divide-y divide-stone-100 text-sm text-stone-700">
                        @foreach($records as $record)
                            <tr class="hover:bg-stone-50/50 transition">
                                <td class="px-6 py-4 font-mono text-stone-600">{{ $record->start_datetime }}</td>
                                <td class="px-6 py-4 font-mono text-stone-500">{{ $record->end_datetime ?? 'Active Ongoing Flow' }}</td>
